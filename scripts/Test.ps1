...
try {
    ...
    foreach ($testName in @('SafeSaveTest', 'PersistenceTest', 'StudentHistoryTest', 'IntegrationTest', 'CourseStorageTest', 'RegistrationConsoleTest', 'AttendanceImportTest')) {
    ...
    Write-Host 'Application build and all seven test suites passed.'
